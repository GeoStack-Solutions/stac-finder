...
## Installations
We use the dependencies ajv, ajv-formats, dotenv,pLimit, pg and winston. To install these, navigate to the path "crawler\" and type "npm install" into the terminal.
